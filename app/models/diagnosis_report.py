...
class DiagnosisEvent(BaseModel):
    ...
    event_type: str = Field(description="事件类型: kg_query | rag_retrieve | mcp_call | reasoning | routing")
    agent: str = Field(default="system", description="执行者: planner | executor | router | knowledge_retriever")
